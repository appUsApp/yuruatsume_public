...
/// ボーナスアイテムのリロール用・報酬広告マネージャ（GMA SDK v11）
@MainActor
final class BonusRewardedAdManager: NSObject {
    ...
    static let shared = BonusRewardedAdManager()
...
extension BonusRewardedAdManager: FullScreenContentDelegate {
